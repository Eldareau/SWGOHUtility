...
Eeth_Koth = Unit("Eeth Koth", 8, 50833, 38865, 164, 1.50, 0.55, 0.37, 0.15, 0.0, 5453, 0.4229, 192, 0.18, 0.398, 0.02, 0.18, 8631, 0.2000, 227, 0.18, 0.401, 0.02, 0.18, ["leader", "galactic_republic", "jedi", "jedi_vanguard", "order_66_raid"], "support", "light_side")
Eeth_Koth.add_move(moves.Breaching_Strike, Eeth_Koth.physical_damage)
